...
export const AboutContent =
	"Witaj! Nazywam się Marcin. Jestem absolwentem studiów informatycznych. Już w technikum informatycznym rozwijałem swoje umiejętności programowania. Polubiłem szczególnie dwie technologie, którymi są .NET i React. Od 2020 roku zajmuję się projektowaniem i tworzeniem oprogramowania zawodowo.";

export const PassionContent =
	"Jestem osobą, która od dłuższego czasu zgłębia tajniki programowania, a moją pasją stało się tworzenie oprogramowania w technologiach .NET i React. Od 2020 roku mam przyjemność pracować zawodowo w tych dziedzinach, co pozwoliło mi rozwinąć umiejętności i zdobyć cenne doświadczenie.";

export const reactProjects = [
	{
		header: "Music converter",
		description:
			"Aplikacja wykorzystująca AI do konwertowania plików audio na typ danych musicSequence. Aplikacja pozwala na wczytanie pliku audio lub wyprowadzonego z mikrofonu. W aplikacji znajdziemy bibliotekę, w której istnieją przykładowe pliki muzyczne. Po utworzeniu konta możemy dodawać i polubić utwory.",
...
export const netProjects = [
	{
		...
		description:
			"Aplikacja UsersNotebook umożliwia zarządzanie użytkownikami: dodawanie, edycję, usuwanie oraz generowanie raportów w PDF. Zbudowana w ASP.NET Core 7 z wykorzystaniem MVC, Entity Framework oraz Docker.",
		repositoryUserName: "xenorsek",
...
export const UnityProjects = [
	{
		header: "QuizUnit",
		description:
			"QuizUnit - jest to gra utworzona w Unity, której przebieg gry oparty jest o Quiz. Pytania zostały dobrane tak by przypominały o podstawie tworzenia gier w Unity. Quiz składał się z 3 scen: Start - Gra - Ekran końcowy. Podczas gry użytkownik musiał odpowiedzieć na pytanie z limitem czasu. Pytania są generowane losowo co utrudnia, użytkownikowi strzelanie. Po odpowiedzeniu na wszystkie pytania, użytkownik witał się z ekranem końcowym, na którym pokazany był jego wynik, oraz przycisk umożliwiający przejście gry ponownie.",
		repositoryUsername: "Xenorsek",
